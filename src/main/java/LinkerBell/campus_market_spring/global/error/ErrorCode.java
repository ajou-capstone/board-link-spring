...
public enum ErrorCode {
    ...
    INVALID_TITLE(HttpStatus.BAD_REQUEST, 4021, "제목은 2글자 이상 100글자 이하여야 합니다."),
    INVALID_DESCRIPTION(HttpStatus.BAD_REQUEST, 4022, "내용은 2글자 이상 2000자 이하여야 합니다."),
    ...
    INVALID_CONTENTTYPE(HttpStatus.BAD_REQUEST, 4040, "잘못된 메시지 conentType입니다."),
